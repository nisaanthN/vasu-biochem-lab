    ...
    <ExperimentShell
      ...
      observations={
        <ul className="space-y-1">
          ...
          <li>
            Baseline: Km = {KM} mM, Vmax = {VMAX} µmol/min.
          </li>
          <li>
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        <Card className="lg:col-span-1">
          ...
          <CardContent className="space-y-5">
            <div>
              <label className="mb-1 block text-sm">Inhibition mode</label>
            ...
            <div>
              <div className="mb-1 flex justify-between text-sm">
                <span>[I] (mM)</span>
                <span className="font-mono">{I.toFixed(1)}</span>
              </div>
            ...
            <div>
              <div className="mb-1 flex justify-between text-sm">
                <span>Ki (mM)</span>
                <span className="font-mono">{Ki.toFixed(2)}</span>
              </div>
        ...
        <Card className="lg:col-span-2">
          <CardHeader>
            <CardTitle className="text-sm">Lineweaver–Burk overlay</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="h-80 w-full">
              <ResponsiveContainer>
                <LineChart data={merged} margin={{ top: 5, right: 10, left: 0, bottom: 16 }}>
                  ...
                  <Line type="monotone" dataKey="baseline" stroke="hsl(var(--muted-foreground))" name="No inhibitor" strokeWidth={2} dot={false} />
                  <Line type="monotone" dataKey="inhibited" stroke="hsl(var(--primary))" name={`+ ${mode}`} strokeWidth={2.5} dot={false} />
                </LineChart>
              </ResponsiveContainer>
            </div>
          </CardContent>
